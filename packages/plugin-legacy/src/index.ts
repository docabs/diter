...
// import { build, normalizePath } from 'dite'
...
//   const isDebug =
//     debugFlags.includes('dite:*') || debugFlags.includes('dite:legacy')
...
//     name: 'dite:legacy-generate-polyfill-chunk',
//     apply: 'build',
...
//         isDebug &&
//           console.log(
//             `[@ditejs/plugin-legacy] modern polyfills:`,
//             modernPolyfills,
//           )
...
//         isDebug &&
//           console.log(
//             `[@ditejs/plugin-legacy] legacy polyfills:`,
//             legacyPolyfills,
//           )
...
//     name: 'dite:legacy-post-process',
//     enforce: 'post',
//     apply: 'build',

//     configResolved(_config) {
//       if (_config.build.lib) {
//         throw new Error('@ditejs/plugin-legacy does not support library mode.')
//       }
//       config = _config
...
//       isDebug && console.log(`[@ditejs/plugin-legacy] targets:`, targets)
...
//     name: 'dite-remove-polyfill-import',
//     post({ path }) {
