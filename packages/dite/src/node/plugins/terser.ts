...
export interface TerserOptions extends Terser.MinifyOptions {
  /**
   * Dite-specific option to specify the max number of workers to spawn
...
//       throw new Error(
//         'terser not found. Since Dite v3, terser has become an optional dependency. You need to install it.',
//       )
//     } else {
