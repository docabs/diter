...
// // const debug = createDebugger('dite:css')
...
//           name: cssAssetName,
//           type: 'asset',
//           source: '/* dite internal call, ignore */',
//         }),
//       )
//     }
//   }
...
//       // when `generateBundle` in dite:build-html plugin and devHtmlHook
...
//         const code = [
//           `import { updateStyle as __dite__updateStyle, removeStyle as __dite__removeStyle } from ${JSON.stringify(
//             path.posix.join(config.base, CLIENT_PUBLIC_PATH),
//           )}`,
//           `const __dite__id = ${JSON.stringify(id)}`,
//           `const __dite__css = ${JSON.stringify(cssContent)}`,
//           `__dite__updateStyle(__dite__id, __dite__css)`,
//           // css modules exports change on edit so it can't self accept
//           `${modulesCode || 'import.meta.hot.accept()'}`,
//           `import.meta.hot.prune(() => __dite__removeStyle(__dite__id))`,
//         ].join('\n')
...
//           chunk.diteMetadata!.importedAssets.add(cleanUrl(filename))
...
//           chunk.diteMetadata!.importedCss.add(this.getFileName(referenceId))
...
//           // Entry chunk CSS will be collected into `chunk.diteMetadata.importedCss`
//           // and injected later by the `'dite:build-html'` plugin into the `index.html`
//           // so it will be duplicated. (https://github.com/ditejs/dite/issues/2062#issuecomment-782388010)
...
//       if (chunk.diteMetadata?.importedCss.size) {
//         let hash = ''
//         for (const id of chunk.diteMetadata.importedCss) {
//           hash += id
//         }
//         return hash
//       }
...
//       if (opts.__dite_skip_asset_emit__) {
//         return
//       }
...
//                   chunk.diteMetadata!.importedCss.add(file),
//                 )
//                 importedAssets.forEach((file) =>
//                   chunk.diteMetadata!.importedAssets.add(file),
//                 )
//                 return false
//               }
//               return true
...
//         },
//         nameLayer(index) {
//           return `dite--anon-layer-${getHash(id)}-${index}`
//         },
//       }),
//     )
//   }
...
//   // inline postcss config via dite config
...
//   return {
//     postcssPlugin: 'dite-url-rewrite',
//     Once(root) {
...
//   // See https://github.com/ditejs/dite/pull/13893#issuecomment-1678628198
...
//   const diteResolverPlugin = createViteLessPlugin(
//     nodeLess,
//     options.filename,
//     options.alias,
//     resolvers,
...
//       ...options,
//       plugins: [diteResolverPlugin, ...(options.plugins || [])],
//       ...(options.enableSourcemap
//         ? {
//             sourceMap: {
